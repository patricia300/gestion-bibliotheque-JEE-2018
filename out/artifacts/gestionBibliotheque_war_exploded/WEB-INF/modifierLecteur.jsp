...
<div class="container pt-5">
    ...
    <form action="ModificationLecteur" method="post" class="align-content-center">
            ...
            <div class="card">
                <div class="card-body mx-4">
                    ...
                    <div class="text-center">
                        <h3 class="dark-grey-text mb-5"><strong>Modification du Lecteur</strong></h3>
                    </div>

                    <!--Body-->
                    <div class="md-form">
                        <input type="text" name="idLecteur" id="Form-email1" readonly class="form-control" value="<c:out value="${lecteur.idLecteur}"/>">
                        <label for="Form-email1">Numero </label>
                        <span>${form.erreurs['idLecteur']}</span>
                    </div>

                    <div class="md-form pb-3">
                        <input type="text" name="nomLecteur" id="Form-pass1" class="form-control" value="<c:out value="${lecteur.nomLecteur}"/>">
                        <label for="Form-pass1">Nom</label>
                        <span>${form.erreurs['nomLecteur']}</span>
                    </div>


                    <div class="md-form pb-3">
                        <input type="text" name="prenomLecteur" id="Form-pass2" class="form-control" value="<c:out value="${lecteur.prenomLecteur}"/>">
                        <label for="Form-pass1">Prénom</label>
